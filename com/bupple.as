package com{
	...
	public class bupple extends MovieClip {
		...
		public function setSpeed(jiaodu:Number,speed:Number=5):void {
		...
		public function checkBomb():MovieClip {
				for(var i:int=0;i<guai_array.length;i++){
					...
					guai_array[i].speed-=apeed
					if(guai_array[i].speed<0.5)
					guai_array[i].speed=0.5
					return guai_array[i];
				}
				}
			return null;
