	...
	public class 螃蟹 extends MovieClip {
		...
		public function setEnemy(pass:Array){
				...
				for(var i:int=pass.length-1;i>=0;i--){
					if(pass[i].currentFrame!=17 && pass[i].speed>0.6){
						enemy=pass[i]
						boo=true
						break
					}
