package {
	...
	public class PointBurst extends Sprite {
		...
		static const fontColor1:Number = 0xff0000;
		static const fontColor2:Number = 0x0000ff;
		
		// animation
		static const animSteps:int = 10;
		static const animStepTime:int = 100;
		...
		public function PointBurst(mc:MovieClip, pts:Object, x,y:Number,color:Number=1) {
			...
			if(color==1)
			tFormat.color = fontColor1;
			else if(color==2)
			tFormat.color = fontColor2;
